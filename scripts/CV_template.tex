...
\renewcommand*{\sectionfont}{%
  ...
  \else%
    \Large\fontseries{eb}\selectfont\upshape\fi}
...
\newbibmacro*{name:bold}[2]{%
  \def\do##1{\IfStrEq{#1, #2}{##1}{\fontseries{eb}\selectfont\listbreak}{}}% not sure why ifstrequal does not work.
...
\forcsvlist{\listadd\boldnames}
  {{Kanai, Masahiro.}, {Kanai, M.}, {Kanai, M\bibinitperiod}}

% highlight journal title
\xpretobibmacro{journal}{\begingroup\color{color1}\bfseries}{}{}
...
\homepage{\VAR{config['url'].replace('http://', '')}}
...
%----------------------------------------------------------------------------------
\section{Education}
\cvcolorentry{Apr. 2013--present}{B.S. in Bioinformatics \textup{(expected)}}{Keio University}{Yokohama, Japan}{\upshape Department of Biosciences and Informatics}{}
%% if private['gpa']
...
\cvcolorentry{Apr. 2016--present}{Undergraduate Researcher}{Keio University}{Yokohama, Japan}{\upshape Laboratory for Bioinformatics}{}
\cvline{Advisor}{Dr. Yasubumi Sakakibara}
\cvline{Bachelor thesis}{Integrative multi-omics analysis of renal cell carcinoma}

\vspace{6pt}
\cvcolorentry{May 2015--present}{Research Assistant}{RIKEN Center for Integrative Medical Sciences}{Yokohama, Japan}{\upshape Laboratory for Statistical Analysis}{}
\cvline{Advisor}{Dr. Yoichiro Kamatani \& Dr. Yukinori Okada}
\cvline{Research theme}{}
...
\cvline{Advisor}{Dr. Yukinori Okada \& Dr. Toshihiro Tanaka}
\cvline{Research theme}{}
\begin{itemize}[leftmargin=.25in, nolistsep]
...
\cvcolorentry{2017--2019+}{}{The Nakajima Foundation Scholarship}{Tokyo, Japan}{}{}
...
%----------------------------------------------------------------------------------
\nocite{*}
\printbibliography[title=Publications, type=article, notkeyword={review}]
